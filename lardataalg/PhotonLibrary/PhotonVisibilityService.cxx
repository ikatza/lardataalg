...
namespace phot{
  ...
  //--------------------------------------------------------------------
  /*
  PhotonVisibilityService::PhotonVisibilityService(::fcllite::PSet const& pset, art::ActivityRegistry &) :
    fCurrentVoxel(0),
    fCurrentValue(0.),
    fXmin(0.),
    fXmax(0.),
  ...
  */
  ...
  //--------------------------------------------------------------------
  //void PhotonVisibilityService::reconfigure(::fcllite::PSet const& p)
